...
public class Main2Activity extends BaseAdapter implements Filterable {
    ...
    public Main2Activity(ArrayList<String> mStringList, Context context) {
    ...
    private class ValueFilter extends Filter implements LayoutInflater.Filter {

...
public class main_fragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new AsyncMovies(getContext() , gv, (MainActivity) getContext() , ((MainActivity) getContext()).getSavedSelection()).execute();

        pri.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MainActivity.saveSelection(true , getContext());
        ...
        cat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity.saveSelection(false , getContext());
        ...
        fav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                movie m [] = ((MainActivity) getContext()).getSavedFavorite();
                if(m != null){

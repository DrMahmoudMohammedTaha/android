...
public class Tesseract1 extends TessAPI1 implements ITesseract {
     ...
     */
    @Override
    public String doOCR(Bitmap bi) throws TesseractException {
     ...
     */
    @Override
    public String doOCR(Bitmap bi, Rectangle rect) throws TesseractException {
        try {
     ...
     * @throws IOException
     */
    protected void setImage(Bitmap image, Rectangle rect) throws IOException {

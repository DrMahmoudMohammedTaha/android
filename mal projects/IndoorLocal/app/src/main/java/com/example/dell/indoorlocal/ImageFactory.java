...
public class ImageFactory {
    ...
    public static void drawOnMap(String[] route) throws IOException {
        ...
        Bitmap bi = ImageIO.read(imageFile);
    ...
    public static void drawLineOnMap(Bitmap bi, int n1, int n2, int color) {
    ...
    public static void drawRoute(Bitmap bi, String[] steps) {
    ...
    public static void drawPoint(Bitmap bi, int num, int color) {
    ...
    public static void getBoundary(Bitmap bi) {
    ...
    public static Bitmap brighten(Bitmap f, float p1, float p2) {
    ...
    public static void saveImage(Bitmap bi, String name) throws IOException {
        File outputfile = new File(name);
        ImageIO.write(bi, "jpg", outputfile);

    }

    public static Bitmap rbg2gray(Image f) {
        ImageFilter filter = new GrayFilter(true, 10);
        ImageProducer producer = new FilteredImageSource(f.getSource(), filter);
        Image mage = Toolkit.getDefaultToolkit().createImage(producer);

        Bitmap buffered = new Bitmap(mage.getWidth(null), mage.getHeight(null), BufferedImage.TYPE_BYTE_GRAY);

        buffered.getGraphics().drawImage(mage, 0, 0, null);
        return buffered;
    }

    public static Bitmap rbg2bw(Image f) {

        Bitmap blackWhite = new BufferedImage(f.getWidth(null), f.getHeight(null), BufferedImage.TYPE_BYTE_BINARY);
    ...
    public static Bitmap bfi[] = new Bitmap[size];

    public static void major(Bitmap bi) {
        int black = 0;
        int white = 0;
    ...
    public static void convertImage(Bitmap bi) {
        ...
        for (int i = 0; i < size; i++) {
            bfi[i] = new Bitmap(bi.getWidth(), bi.getHeight(), BufferedImage.TYPE_3BYTE_BGR);
        }

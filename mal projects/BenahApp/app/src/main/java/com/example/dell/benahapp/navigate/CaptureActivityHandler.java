 ...
 */
package com.example.dell.benahapp.navigate;
...
import com.example.dell.benahapp.navigate.camera.CameraManager;
  ...
  public void handleMessage(Message message) {
    ...
    switch (message.what) {
      ...
      case R.id.ocr_decode_succeeded:
        ...
        Log.e("my work" , ((OcrResult) message.obj).getText());
        Intent returnIntent = CaptureActivity.app.getIntent();
        returnIntent.putExtra("result",((OcrResult) message.obj).getText());
        CaptureActivity.app.setResult(CaptureActivity.app.RESULT_OK,returnIntent);
        CaptureActivity.app.finish();
        break;
      case R.id.ocr_decode_failed:
        state = State.PREVIEW;
        activity.setShutterButtonClickable(true);
        Toast toast = Toast.makeText(activity.getBaseContext(), "OCR failed. Please try again or close.", Toast.LENGTH_SHORT);

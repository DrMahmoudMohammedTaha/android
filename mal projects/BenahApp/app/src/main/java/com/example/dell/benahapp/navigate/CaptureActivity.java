...
import com.example.dell.benahapp.navigate.camera.ShutterButton;
import com.example.dell.benahapp.navigate.language.LanguageCodeHelper;
import com.example.dell.benahapp.navigate.language.TranslateAsyncTask;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ...
  void onShutterButtonPressContinuous() {
    ...
    if (lastResult != null) {
      ...
      Toast toast = Toast.makeText(this, "OCR failed. Please try again and again.", Toast.LENGTH_SHORT);

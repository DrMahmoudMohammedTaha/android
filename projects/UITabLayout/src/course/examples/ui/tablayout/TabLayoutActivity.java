...
public class TabLayoutActivity extends Activity {
	...
	private static final String HFSA_TABSTRING = "Hfsa";
	...
	// List of Hfsa thumbnail images
	private ArrayList<Integer> mThumbIdsHFSA = new ArrayList<Integer>(
			Arrays.asList(R.drawable.pic1, R.drawable.pic2,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Create a GridFragment for HFSA thumbnails
				GridFragment HfsaFrag = new GridFragment();

				// Store the list of thumbnails as an argument to the GridFragment
				args = new Bundle();
				args.putIntegerArrayList(THUMBNAIL_IDS, mThumbIdsHFSA);
				HfsaFrag.setArguments(args);

				// Configure a tab for the Animal thumbnail GridFragment
				tabBar.addTab(tabBar.newTab().setText(HFSA_TABSTRING)
						.setTabListener(new TabListener(HfsaFrag)));
